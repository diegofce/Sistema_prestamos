	...
	<div class="full-box nav-lateral-content">
		<figure class="full-box nav-lateral-avatar">
			...
			<figcaption class="roboto-medium text-center">
				<?php echo $_SESSION['nombre_spm']." ".$_SESSION['apellido_spm']; ?> <br><small class="roboto-condensed-light"> Nivel de Privilegio ➡️  
					 <?php echo $_SESSION['privilegio_spm']; ?> </small>
			</figcaption>
		</figure>
			...
			<ul>
				...
				<li>
					...
					<ul>
						...
						<li>
							<a href="<?php echo SERVERURL; ?>client-list/"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; Lista de Estudiantes Registrados</a>
						</li>
						<li>
				...
				?>
				<li>
					<a href="<?php echo SERVERURL; ?>company/"><i class="fas fa-store-alt fa-fw"></i> &nbsp; SEDE SENA</a>
				</li>
				<?php } ?>
			</ul>
		</nav>
