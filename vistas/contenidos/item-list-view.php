<div class="full-box page-header">
    ...
    <p class="text-justify">
        Aquí puedes visualizar todos los items registrados en el sistema. Puedes agregar nuevos items, actualizar la información existente o eliminar items que ya no sean necesarios.
    </p>
</div>
