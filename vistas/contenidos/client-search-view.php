<div class="full-box page-header">
	...
	<p class="text-justify">
		Aqui puedes buscar un estudiante en el sistema. Ingresa el documento del estudiante y presiona el boton buscar.
	</p>
</div>
...
<div class="container-fluid">
	<ul class="full-box list-unstyled page-nav-tabs">
		...
		<li>
			<a class="active" href="<?php echo SERVERURL; ?>client-search/"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR</a>
		</li>
	</ul>	
</div>
<?php
...
<div class="container-fluid">
	<?php
		...
		echo $ins_cliente->paginador_cliente_controlador($pagina[1],15,$_SESSION['privilegio_spm'],$_SESSION['id_spm'],$_SESSION['busqueda_cliente']);
	?>
</div>
<?php } ?>