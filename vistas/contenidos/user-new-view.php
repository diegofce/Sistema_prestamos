...
<div class="full-box page-header">
	...
	<p class="text-justify">
		Aquí puedes registrar un nuevo usuario en el sistema. Completa el formulario con la información requerida y guarda los datos.
	</p>
</div>
		...
		<fieldset>
			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-12 col-md-6">
						<div class="form-group">
							<label for="usuario_direccion" class="bmd-label-floating">Programa Academico</label>
							<input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#- ]{1,190}" class="form-control" name="usuario_programa_reg" id="usuario_programa" maxlength="190">
						</div>
					</div>
				</div>
			</div>
