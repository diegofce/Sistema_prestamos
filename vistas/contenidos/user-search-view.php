...
<div class="full-box page-header">
	...
	<p class="text-justify">
		Aquí puedes buscar un usuario en el sistema. Ingresa el nombre, apellido o número de identificación del usuario que deseas encontrar y obtén los resultados de la búsqueda.
	</p>
</div>
