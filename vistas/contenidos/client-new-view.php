<div class="full-box page-header">
	...
	<p class="text-justify">
		Aqui puedes registrar un nuevo estudiante en el sistema. Completa el formulario con la información requerida y guarda los datos.
	</p>
</div>
...
<div class="container-fluid">
	<ul class="full-box list-unstyled page-nav-tabs">
		<li>
			<a class="active" href="<?php echo SERVERURL; ?>client-new/"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR ESTUDIANTE</a>
		</li>
		<li>
			<a href="<?php echo SERVERURL; ?>client-list/"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA ESTUDIANTES</a>
		</li>
		<li>
