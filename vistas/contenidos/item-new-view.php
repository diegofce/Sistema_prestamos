<div class="full-box page-header">
    ...
    <p class="text-justify">
        Aquí puedes registrar un nuevo item en el sistema. Completa el formulario con la información requerida y guarda los datos.
    </p>
</div>
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        ...
        <li>
            <a href="<?php echo SERVERURL; ?>item-search/l"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR ITEM</a>
        </li>
    </ul>
</div>
