...
<div class="full-box page-header">
	...
	<p class="text-justify">
		Aquí puedes actualizar la información de un usuario existente en el sistema. Modifica los campos necesarios y guarda los cambios para mantener la información actualizada.
	</p>
</div>
